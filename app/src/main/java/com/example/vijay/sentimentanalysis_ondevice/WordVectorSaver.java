...
public class WordVectorSaver {
     ...
     * @param file
     */
    public void writeParagraphVectors(ParagraphVectors vectors, File file) {
     ...
     * @param path
     */
    public void writeParagraphVectors(ParagraphVectors vectors, String path) {
     ...
     *
     */
    public void writeWord2VecModel(Word2Vec vectors, File file) {
        try (FileOutputStream fos = new FileOutputStream(file);
             BufferedOutputStream stream = new BufferedOutputStream(fos)) {
     ...
     *
     */
    public  void writeWord2VecModel(Word2Vec vectors, String path) {
     ...
     *
     */
    public  void writeWord2VecModel(Word2Vec vectors, OutputStream stream) throws IOException {
